...
<img src={require('./img/LED/勾选生成独立初始化文件.png').default} alt="勾选生成独立初始化文件" width="60%" />

- 打开.ioc配置文件时弹出对话框”New STM32Cube firmware version available“：因为您的软件版本比例程高，此时建议直接点击”Migrate“迁移到您的版本即可，以后再打开就不会出现了。

<img src={require('./img/LED/New version dialog.png').default} alt="New version dialog" width="60%" />
