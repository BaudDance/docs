...
**下载例程代码：** <a href="https://pan.baidu.com/s/1Mdes2lw2Zo1dpvHLsPQzlA?pwd=1234" class="source_download_button">下载代码</a>
...
- **配置TIM3：**在Pinout&Configuration -> Timers -> TIM3
  ...
  - Configuration -> GPIO Settings，将PB4的GPIO mode配置为 Alternate Function Open Drain
