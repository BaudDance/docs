...
**下载例程代码**： <a href="https://pan.baud-dance.com/d/%E6%B3%A2%E7%89%B9%E5%BE%8B%E5%8A%A8STM32%E4%BE%8B%E7%A8%8B/WS2812.zip" class="source_download_button" target="_blank">下载代码(CubeIDE)</a> 
<a href="https://fubestore.baud.dance/WS2812_keil.7z" class="source_download_button" target="_blank">下载代码(keil V6)</a>
...
:::info
查看 <a href="/docs/stm32/resourcePack/#配套模块手册" target="_blank">**WS2812手册.PDF 🔗**</a>
:::
...
- **配置TIM3**：在Pinout&Configuration -> Timers -> TIM3
  ...
  :::tip
  由于WS2812信号电平是5V的，故必须用「**开漏输出模式**」，外接5V上拉电阻，使信号高电平变成5V
  :::
  :::info
  PB4是「5V耐受引脚」，可以安全耐受 5V 上拉。普通引脚则不可以超过 3.3V
  :::
