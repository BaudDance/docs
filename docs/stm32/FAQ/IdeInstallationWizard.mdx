...
如下图所示：
<img src={require('./img/安装界面1.png').default} alt="安装界面1" width="30%" />
<img src={require('./img/安装界面2.png').default} alt="安装界面2" width="30%" />
<img src={require('./img/安装界面3.png').default} alt="安装界面3" width="30%" />
...
<img src={require('./img/安装后界面1.png').default} alt="安装后界面" width="60%" />  
...
<img src={require('./img/开始界面1.png').default} alt="开始界面1" width="60%" />
