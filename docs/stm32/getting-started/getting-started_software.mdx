...
<a href="/docs/stm32/FAQ/changeTheme" target="_blank">**更换浅色主题🔗**</a>，即可跟教程一样白底浅色界面。
...
此时必须按 <a href="/docs/stm32/FAQ/login" target="_blank">**登录方法🔗**</a> 登录后，再从第 1️⃣ 步开始重新创建工程，否则工程创建不完整无法下载
...
<a href="/docs/stm32/getting-started/getting-started_hardware" target="_blank">**下载工程到硬件**：如何将工程下载到学习板 🔗</a>