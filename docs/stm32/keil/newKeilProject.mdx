...
<img src={require('./img/复位1.png').default} alt="复位1" width="600px" />
</div>

#### 2️⃣ 点击 `Flash Download` 选项卡，勾选 `Reset and Run`

<div style={{ display: "flex", justifyContent: "center", alignItems: "center", marginBottom: "20px"}}>
<img src={require('./img/复位2.png').default} alt="复位2" width="600px" />
</div>

#### 3️⃣ 点击 `Pack` 选项卡，取消勾选 `Enable`，点击确定即可 

<div style={{ display: "flex", justifyContent: "center", alignItems: "center", marginBottom: "20px"}}>
<img src={require('./img/复位3.png').default} alt="复位3" width="600px" />
</div>
